        ...
        <div className="bg-[#0B0B0B] flex justify-around max-w-screen z-20 sticky bottom-0">
            ...
            <div className="my-8 w-2xl">
                ...
                <div className="flex justify-between mt-2 text-white/70 z-20 text-sm">
                    <span className="bg-[radial-gradient(circle,#0B0B0B_0%,rgba(11,11,11,0.6)_50%,rgba(11,11,11,0.1)_100%)] z-20 text-sm">{formatTime(currentTimeMs)}</span>
                    <span className="bg-[radial-gradient(circle,#0B0B0B_0%,rgba(11,11,11,0.6)_50%,rgba(11,11,11,0.1)_100%)] z-20 text-sm">{formatTime(totalDuration)}</span>
                </div>
