...
function extractBandcampData(
    ...
    if (!tralbumMatch) {
        return {
            success: false,
            message: "Could not extract track data from Bandcamp page",
        }
    }
    ...
    if (!ldJson) {
        return {
            success: false,
            message: "Could not extract ld+json from Bandcamp page",
        }
    }
    ...
    if (!albumArt) {
        return {
            success: false,
            message: "Could not extract album art from Bandcamp page",
        }
    }
